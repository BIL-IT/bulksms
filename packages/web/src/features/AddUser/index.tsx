...
export default function AddUserComponent() {
  ...
  const onSubmit = (data: z.infer<typeof userSchema>) => {
    const { confirmPassword, ...otherDetils } = data;

    addUserMutation({
      variables: {
        signupDetails: otherDetils,
      },
    })
      .then(() => {
        toast({
      ...
      >
        ...
        <div className="mt-5 flex flex-col gap-4 [&>div>label]:mb-2">
          ...
          <div className="flex flex-col">
            ...
            <div className="relative flex items-center">
              <div className="flex flex-row border-2 h-10 rounded-md items-center px-4 gap-3 w-96">
                <Lucide.User className="text-primary" width={16} height={16} />
                <input
                ...
                >
                  {getValues("department")
                    ? siteConfig
                        .getDepartmentList()
                        .find(
                          (department) => department === getValues("department")
                        )
                    : "Select a Department..."}
          ...
          <div className="flex flex-col">
            ...
            <div className="relative flex items-center">
              <div className="flex flex-row border-2 h-10 rounded-md items-center px-4 gap-3 w-96">
                <Lucide.Lock className="text-primary" width={16} height={16} />
                <input
                  className="outline-none flex-1"
                  type="password"
